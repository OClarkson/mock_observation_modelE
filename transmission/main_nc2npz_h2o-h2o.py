...
XSFILE_CNTNM = "/Users/yuka/Dropbox/Abs_coeff/h2o-h2o_lbl_sw.nc"
XSFILE       = "xstbl/xstbl_HITRAN2012_00010-10000_m09991_H2O_c25.npz"
OUTFILE      = "xstbl/xstbl_HITRAN2012_00010-10000_m09991_H2O-H2O_cnt.npz"
...
def read_nc_cnt( infile ):
    ...
    xs_grid = ncfile_r.variables['kabs'][:,::100].T.reshape( [ len( wn_grid ), T_DIM, P_DIM ] )
